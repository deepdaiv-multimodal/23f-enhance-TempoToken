...
class TextToVideoSDPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def _encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            print("text_input_ids = text_inputs.input_ids", text_input_ids)
            ...
            # print("prompt_embeds = prompt_embeds[0] 전의 prompt_embeds", prompt_embeds.size())
            print("prompt_embeds[0]", prompt_embeds[0].size)
            prompt_embeds = prompt_embeds[0]
            print("prompt_embeds = prompt_embeds[0] 후의 prompt_embeds", prompt_embeds.size())
