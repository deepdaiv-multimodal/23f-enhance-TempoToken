...
class CLIPTextTransformer(nn.Module):
    ...
    def forward(
        ...
        print("encoder 들어가기 전 hidden_states", hidden_states.size()) # hidden_states torch.Size([24, 77, 1024])
        ...
        if attention_mask is not None: # None인걸 확인!!
        ...
        print("last_hidden_state (=encoder_outputs[0]) = ",encoder_outputs[0].size )
